...
local extra_song_harp = {
    ...
    [21407] = 3, -- Terpander
	[22306] = 3, -- Loughnashade II
	[22307] = 4, -- Loughnashade III
    }
...
local aria_of_passion_horn = {
    [22305] = true, -- Loughnashade I
	[22306] = true, -- Loughnashade II
	[22307] = true -- Loughnashade III
    }
    ...
    for _, bag in ipairs(equippable_bags) do
        ...
        if items.enabled then
            for i,v in ipairs(items) do
                ...
                elseif aria_of_passion_horn[v.id] and #get.songs.aria == 2 then
                    table.insert(get.songs.aria, 1, 'Aria of Passion')
