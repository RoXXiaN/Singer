_addon.author = 'Ivaar, modified by Rox'
...
setting = T{
    ...
    songs = L{"Honor March","Valor Minuet V","Valor Minuet IV","Valor Minuet III","Aria of Passion",},
    song = {},
    playlist = T{
        clear = L{}
    },
...
local buttons = {'active','actions','soul_voice','clarion','nightingale','troubadour','pianissimo','debuffing','party','p1','p2','p3','p4','p5'}
...
local display_box = function()
	...
	str = str..colorize(3, '\n Soul Voice:[%s]':format(settings.soul_voice and 'On' or 'Off'))
    str = str..colorize(4, '\n Clarion Call:[%s]':format(settings.clarion and 'On' or 'Off'))
