...
#### If you are updating from a version prior to 1.20 make sure you delete your existing settings.xml file located within the addons data folder.
...
Accepts auto-translated terms.
	...
	//sing soul_voice [on|off]          -  Toggle soul voice usage, can be shortened to s.
